...
.pull-left[
- Binwidth of 5 could make people not only see the difference but also group the data. 
- Two colors of binwidth make people easy to compare the frenquency of survival or not. 
]
