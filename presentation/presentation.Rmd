...
>>>>>>> f80feb28c6658579ea772ccf0b0a456e74b3994c
...
+ **Intercept**: 
    > A positive value of the intercept indicates that a female, first class passenger, aged 0 to 6 is expected to survive according to the model.
]

.pull-right[
```{r ref.label="titanic-fit-to-train", echo=FALSE, size = "tiny"}
```
]
...
---
```{r titanic-predict-test-data, echo=FALSE}
...
---
.pull-left[
``` {r titanic-roc-curve, echo=FALSE}
titanic_pred %>%
