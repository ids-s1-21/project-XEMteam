...
---
```{r titanic-map-ports, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "Image credit: Thesun.co.uk"}
include_graphics("https://www.thesun.co.uk/wp-content/uploads/2016/12/composite-sea-map.jpg")
```
